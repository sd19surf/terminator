(function (global, factory) {
	...
	(global.L = global.L || {}, global.L.terminator = factory(global.L)); }(this, (function (L) { 'use strict';
	...
	var Terminator = L.Polygon.extend({
		...
		initialize: function (options) {
			...
			var latLng = this._compute(this.options.time,this.options.twilight);
		...
		_latitude: function (ha, sunPos) {
			...
			return lat;
            //this point would be where the elevation angle equals zero
            // rewrite this equation to accept solar elevation angle
		},

		_compute: function (time,twilight) {
			...
			for (var i = 0; i <= 720 * this.options.resolution; i++) {
				...
				latLng[i + 1] = [this._latitude(ha, sunEqPos,twilight), lng-twilight];
			}
			if (sunEqPos.delta < 0) {
				latLng[0] = [90, -360];
